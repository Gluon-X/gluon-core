...
exports.realDummyData = void 0;
const enums_new_1 = require("./enums.new");
exports.realDummyData = {
    GID11060001: {
      ...
      của nón sáng này.`,
            answer: 97.5,
            approx: 0.5,
            type: enums_new_1.BoxType.SHORT_ANSWER
        },
        helps: [
            {
            ...
            tượng gì xảy ra không?`,
              ...
              toàn phần không được đáp ứng.`
                        ...
                        type: enums_new_1.BoxType.MULTIPLE_CHOICES
                    },
                    // second box
                    {
            ...
            dễ dàng vẽ được sơ đồ mô tả hiện tượng như sau:`,
                        type: enums_new_1.BoxType.DISPLAY
                    }, {
...
//# sourceMappingURL=dummy_data.new.js.map